...
function WorkplaceContent() {
  ...
  return <main className="min-h-screen bg-bg px-4 pt-6 pb-28">
    <p className="text-[13px] font-bold text-primary">{isGigworker?'긱워커 근태':'내 직장'}</p><h1 className="text-[26px] font-extrabold text-ink mt-1">{isGigworker?'오늘 근무':'출퇴근·휴가'}</h1>
