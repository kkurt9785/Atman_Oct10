export default function LegalPage() {
  return (
    <main className="min-h-screen bg-white px-6 py-12">
      ...
      <ul className="mt-6 list-disc pl-5 space-y-3 text-[14px] text-ink"><li>수집 항목: 이름, 연락처, 생년월일, 직군별 면허·경력, 계좌, 위치</li><li>이용 목적: 본인 확인, 공고 지원, 출퇴근, 사업장 직접 임금지급 관리, 고객지원</li><li>보관 기간과 파기 기준은 공개 출시 전 확정</li><li>민감 문서는 비공개 저장소와 제한시간 링크로 제공</li></ul>
