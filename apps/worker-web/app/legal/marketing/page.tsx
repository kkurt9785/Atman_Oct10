export default function LegalPage() {
  return (
    <main className="min-h-screen bg-white px-6 py-12">
      ...
      <ul className="mt-6 list-disc pl-5 space-y-3 text-[14px] text-ink"><li>선택 동의이며 거부해도 핵심 서비스 이용 가능</li><li>혜택·신규 시프트 관련 마케팅 알림에 사용</li><li>설정에서 언제든 철회 가능</li><li>거래·보안·정산 알림은 마케팅 동의와 별도</li></ul>
