...
export default function NotificationsPage() {
  ...
  useEffect(() => { setGigworkerMode(window.localStorage.getItem('atman_gigworker_mode')==='1'); void load(); }, [load]);
