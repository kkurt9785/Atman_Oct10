  ...
  return (
    <main className="min-h-screen bg-surface px-4 pb-24">
      ...
      <div className="mt-2 px-1">
        <p className="text-label font-bold text-primary">잇닿 운영</p>
        <h1 className="mt-1 text-display font-extrabold text-ink">사업장 승인</h1>
        <p className="mt-2 text-body text-sub">셀프 등록한 사업장은 사업자등록번호를 확인한 뒤 승인해야 공고를 올릴 수 있어요. 운영자 {session.user.email}</p>
      </div>
