      ...
      <section className="rounded-2xl bg-white p-5">
        ...
        {hasPin ? (
          ...
          <div className="mt-1.5">
            <p className="rounded-xl bg-amber-50 p-3 text-[12px] leading-5 text-amber-700">아직 출퇴근 인증 위치가 없어요. 지금 사업장 안에 계시면 아래 버튼 한 번으로 정해집니다.</p>
            {canEdit && <CurrentLocationButton className="mt-2" radiusMeters={gpsRadiusMeters} onChange={({ lng, lat }) => setForm(c => ({ ...c, lng, lat }))} />}
          </div>
        )}
