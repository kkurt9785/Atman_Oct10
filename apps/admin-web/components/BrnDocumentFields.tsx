...
export function BrnDocumentFields({ brn, file, onBrn, onFile, disabled, existingDocument }: {
  brn: string; file: File | null; onBrn: (v: string) => void; onFile: (f: File | null, error?: string) => void; disabled?: boolean; existingDocument?: boolean;
}) {
  return (
