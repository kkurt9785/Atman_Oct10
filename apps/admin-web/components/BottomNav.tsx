...
export function BottomNav() {
  ...
  return (
    <nav aria-label="주요 메뉴" className="fixed bottom-0 inset-x-0 z-30 mx-auto max-w-app bg-white border-t border-line flex pb-[env(safe-area-inset-bottom)]">
      ...
      <Link href="/notifications" aria-label="알림" className={`flex-1 flex flex-col items-center justify-center gap-0.5 min-h-tap py-2 ${path.startsWith('/notifications') ? 'text-primary' : 'text-sub'}`}>
