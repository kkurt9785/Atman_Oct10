...
const stories = {
  admin: {
    ...
    scenes: [
      ...
      ['00-facility-search', '0. 사업장 등록 — 검색', '이름만 검색하면 바로 찾기', '처음 한 번, 사업장 이름을 검색합니다. 이미 잇닿에 있는 사업장은 초대 코드로 연결하고, 없으면 지도 검색 결과에서 바로 등록할 수 있습니다.'],
      ['00-facility-register', '0. 사업장 등록 — 위치 확정', '출입구에 핀을 맞추면 출퇴근 인증 기준 완성', '주소와 전화를 확인하고, 지도에서 출입구 위치에 핀을 맞춥니다. 등록하면 같은 자리의 심평원 요양기관 정보와 자동으로 대조하고, 이 위치가 직원 출퇴근 인증의 기준이 됩니다.'],
